...
class SakanyaCore():
  ...
  def bot_token(self, debug):
    if debug is True:
      ...
      return '***REMOVED***'
  startup_extensions = ['commands.love', 'commands.about', 'commands.restart', 'commands.saka', 'commands.help', 'commands.robot', 'commands.update', 'commands.iam', 'other.filemanagement', 'other.suggestioncontrol', 'other.mentioninteraction', 'other.uselessinteractions', 'other.presenceupdate']
