...
class About():
  ...
  async def about(self):
    ...
    .add_field(name='About', value='As much as I don\'t want to admit it, I\'m a Discord bot written in *discord.py* by FoxInFlame#9833. I am not an actual cute girl.\n(｡•́︿•̀｡)', inline=False)
